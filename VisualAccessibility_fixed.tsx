...
export const FocusIndicator: React.FC<FocusIndicatorProps> = ({
  ...
  const currentStyle = focusStyles[variant];
  const boxShadowValue = 'boxShadow' in currentStyle ? currentStyle.boxShadow : '';

  return (
    <div 
      className="focus-indicator-container"
      style={{
        "--focus-outline": currentStyle.outline,
        "--focus-outline-offset": currentStyle.outlineOffset,
        "--focus-box-shadow": boxShadowValue,
